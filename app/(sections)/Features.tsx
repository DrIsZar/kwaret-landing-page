...
import { Zap, ShieldCheck, BadgePercent, Headphones } from 'lucide-react'
...
const features = [
  {
    ...
    description: 'Get your premium accounts activated within minutes of payment confirmation.'
  },
  {
    icon: ShieldCheck,
    title: 'Full Warranty',
  ...
  },
  {
    icon: Headphones,
    title: '24/7 Support',
    description: 'Our team is available around the clock to help you with any questions or issues.'
  }
]
          ...
          >
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
              <div className="text-center">
                <div className="text-3xl md:text-4xl font-bold text-k-yellow">1000+</div>
              ...
              <div className="text-center">
                <div className="text-3xl md:text-4xl font-bold text-k-yellow">24/7</div>
